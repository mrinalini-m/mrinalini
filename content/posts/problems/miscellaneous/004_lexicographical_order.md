...
Given an array of key and value strings. Eg. `['key1 abcd', 'key2 zzz', 'key1 hello', 'key3 world', 'key1 hello']` return an array of key value pairs where the value is of the highest lexicographical order. Eg. `[ 'key1:3,hello', 'key2:1,zzz', 'key3:1,world' ]`
