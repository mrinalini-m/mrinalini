---
title: Ch01-01 - Is Unique [Cracking the Coding Interview]
date: 2020-04-17
slug: ctci-ch0Ch01-01-is-unique
tags:
  - ctci
  - algorithms
  - string
...
Time complexity - O(n!) or O(min(c, n!)). I think n^2 isn't corrent.
Because you're only checking n - i chars for each char. i.e. (n - 1) + (n - 2) + ... + 1
*/
